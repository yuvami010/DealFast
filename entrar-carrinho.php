...
if (isset($_SESSION['usuario_id'])) {
    header("Location: lg-carrinho.html");
    exit;
}
...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($senha, $usuario['senha'])) {
            ...
            header('Location: lg-carrinho.html'); // Redireciona para a página de dashboard
            exit;
        } else {
            // Senha incorreta
...
<header>
    ...
    <section>
        <div class="form">
            <form action="entrar-carrinho.php" method="POST">
                <h2>Entrar</h2>
                ...
                <!-- Link para Registro -->
                <p class="message">Ainda não tem uma conta? <a href="criarconta-carrinho.php">Criar Conta</a></p>
            </form>
        </div>
    </section>
</body>
