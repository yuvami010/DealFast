...
if (isset($_POST['submit'])) {
    ...
    if ($validado) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: entrar-reparacao.php"); // Redirecionar após sucesso
            exit();
        } else {
...
<body>
    ...
    <section class="sessao-2">
        <div class="form">
            <form action="criarconta-reparacao.php" method="POST">
                ...
                <p class="message">Já tem uma conta? <a href="entrar-reparacao.php">Entrar</a></p>
            </form>
        </div>
    </section>
