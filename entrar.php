...
if (isset($_SESSION['usuario_id'])) {
    header("Location: lg-inicio.html");
    exit;
}
...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($senha, $usuario['senha'])) {
            ...
            header('Location: lg-inicio.html'); // Redireciona para a página de dashboard
            exit;
        } else {
            // Senha incorreta
    ...
    <section>
        <div class="form">
            <form action="entrar.php" method="POST">
                ...
                <!-- Link para Registro -->
                <p class="message">Ainda não tem uma conta? <a href="criarconta.php">Criar Conta</a></p>
            </form>
        </div>
    </section>
</body>
